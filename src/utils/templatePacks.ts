...
export const templatePacks: TemplatePack[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { layoutId: 'quote', name: 'Quote' },
      { layoutId: 'thank-you', name: 'Thank You' },
    ],
  },
  {
    id: 'pitch-deck',
    ...
    slides: [
      ...
      { layoutId: 'stats-metrics', name: 'Traction' },
      { layoutId: 'comparison', name: 'Competition' },
      { layoutId: 'team-bio', name: 'Team' },
      { layoutId: 'thank-you', name: 'Contact' },
    ],
  },
  {
    id: 'business-report',
  ...
  },
  {
    ...
    slides: [
      { layoutId: 'title-slide', name: 'Intro' },
      { layoutId: 'section-header', name: 'About Me' },
      { layoutId: 'two-column', name: 'Work' },
      { layoutId: 'quote', name: 'Philosophy' },
